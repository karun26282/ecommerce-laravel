	...
	function Edit(data){
		$.ajax({
			...
			{ //alert(JSON.stringify(data1));
				$("#ids").val(data1.id);
				$("#updateCategory").val(data1.category);
				$("#img").html("<img src='/storage/"+data1.image+"'  width='150px'>");
			}
		  });
	}
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<input type="text" class="form-control" name="category" id="categories" value="" placeholder="Enter new category" />
									</div>
								</div>
								<div class="col-md-12">
								    <p>IMAGE</p>
						...
						<div class="form-body">
							<div class="row">
								<div class="col-md-12">
									<p>CATEGORY</p>
									<div class="form-group">
										<input type="text" name="category" id="updateCategory" class="form-control" placeholder="Enter category">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
